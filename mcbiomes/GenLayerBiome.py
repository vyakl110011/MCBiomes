            ...
            for j in range(aW):
                ...
                if self.isBiomeOceanic(k):
                    ...
                    if l > 0:
                        ...
                        aint1[j + i * aW] = [2, 2, 2, 35, 35, 1][
                            self.nextIntGen(6)
                        ]  # desert, savannah or plains
                elif k == 2:
                    if l > 0:
                        aint1[j + i * aW] = 21  # jungle
                    else:
                        aint1[j + i * aW] = [4, 29, 3, 1, 27, 6][
                            self.nextIntGen(6)
                    ...
                    if l > 0:
                        ...
                        aint1[j + i * aW] = [4, 3, 5, 1][
                            self.nextIntGen(4)
                        ]  # forest,extreme hills,taiga,plains
                elif k == 4:
                    aint1[j + i * aW] = [12, 12, 12, 30][
                        self.nextIntGen(4)
                    ]  # ice plains (flats),cold taiga
                else:
